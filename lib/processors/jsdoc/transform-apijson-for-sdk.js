  ...
  *
   ...
   *
		...
		JSDocUtil: function() {
			...
			function format(src, options) {
				...
				const beforeFirstParagraph = options.beforeFirstParagraph === undefined ? beforeParagraph : options.beforeFirstParagraph;
				const afterLastParagraph = options.afterLastParagraph === undefined ? afterParagraph : options.afterLastParagraph;
   ...
   *
		...
		buildConstructorParameters: function(aParameters) {
			...
			var processNode = function(oNode, sPhoneName, iDepth, aNodes) {
				// Handle phone name
